    ...
    <section id="about" className="py-20 md:py-28 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-4xl mx-auto mb-16">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[var(--color-primary)] mb-10 md:mb-12">
            {d.heading}
          </h2>

          <div className="grid md:grid-cols-2 gap-8 md:gap-12 text-left">
            <div className="bg-gradient-to-br from-[var(--color-light)] to-white rounded-2xl p-6 md:p-8 border border-gray-100 hover:shadow-lg transition-shadow duration-300">
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-[var(--color-primary)] mb-4">{d.visionTitle}</h3>
              <p className="text-gray-600 text-base sm:text-lg leading-relaxed">{d.visionText}</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-[var(--color-light)] to-white rounded-2xl p-6 md:p-8 border border-gray-100 hover:shadow-lg transition-shadow duration-300">
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-[var(--color-primary)] mb-4">{d.missionTitle}</h3>
              <p className="text-gray-600 text-base sm:text-lg leading-relaxed">{d.missionText}</p>
            </div>
          </div>
        </div>
      </div>
