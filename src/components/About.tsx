          ...
          <div className="grid md:grid-cols-2 gap-12 text-left">
            ...
            <div className="bg-gradient-to-br from-[var(--color-light)] to-white rounded-2xl p-8 border border-gray-100 hover:shadow-lg transition-shadow duration-300">
              ...
              <p className="text-gray-600 text-lg leading-relaxed">
                Redefining the future of industrial materials through sustainable, bio-based solutions and circular innovation.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-[var(--color-light)] to-white rounded-2xl p-8 border border-gray-100 hover:shadow-lg transition-shadow duration-300">
              ...
              <p className="text-gray-600 text-lg leading-relaxed">
                At Pili AdheSeal, we transform agricultural waste into innovative yet high-performance solutions that create value for industries, empower farming communities, and protect the environment.
              </p>
            </div>
          </div>
        </div>
