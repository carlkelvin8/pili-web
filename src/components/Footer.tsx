        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="mt-6 flex gap-3">
              <a
                href="https://www.linkedin.com/company/piliadheseal/"
                target="_blank"
              ...
              <a
                href="https://www.facebook.com/piliadheseal"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Facebook"
                className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center hover:bg-[var(--color-accent)] transition-colors"
              ...
              <a
                href="https://www.instagram.com/piliadheseal"
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm">
              ...
              <li><a href="#products" className="hover:text-[var(--color-primary-light)] transition-colors">Pili Glue Stick</a></li>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm">
              ...
              <li><a href="#news" className="hover:text-[var(--color-primary-light)] transition-colors">News</a></li>
              <li><a href="#contact" className="hover:text-[var(--color-primary-light)] transition-colors">Contact</a></li>
              <li><a href="/messages" className="hover:text-[var(--color-primary-light)] transition-colors">Messages</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm">
              <li>
                <a href="https://www.linkedin.com/company/piliadheseal/" target="_blank" rel="noopener noreferrer" className="hover:text-[var(--color-primary-light)] transition-colors">
                  LinkedIn
                </a>
              </li>
              <li>
                <a href="https://www.facebook.com/piliadheseal" target="_blank" rel="noopener noreferrer" className="hover:text-[var(--color-primary-light)] transition-colors">
                  Facebook
                </a>
              </li>
              <li>
                <a href="https://www.instagram.com/piliadheseal" target="_blank" rel="noopener noreferrer" className="hover:text-[var(--color-primary-light)] transition-colors">
                  Instagram
                </a>
              </li>
            </ul>
